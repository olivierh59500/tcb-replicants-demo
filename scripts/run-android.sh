...
echo "→ Lancement de TCB Replicants"
"$adb_path" shell am force-stop com.olivierh.tcbreplicants
"$adb_path" shell am start -n com.olivierh.tcbreplicants/.MainActivity
